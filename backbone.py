...
class ResNet(nn.Module):
    ...
    def __init__(self, block, keep_prob=1.0, avg_pool=True, drop_rate=0.0, dropblock_size=5, flatten=False):
        self.inplanes = 3
        ...
        #           Flatten()
        #     )
        self.up4 = nn.Sequential(nn.Conv2d(640,320, kernel_size=1, stride=1,padding=0, bias=False),
